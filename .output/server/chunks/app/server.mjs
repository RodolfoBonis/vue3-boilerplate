import { version, useSSRContext, getCurrentInstance, inject, ref, watchEffect, watch, defineComponent, createApp, reactive, unref, mergeProps, provide, onErrorCaptured, onServerPrefetch, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, nextTick } from 'vue';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<h1${ssrRenderAttrs(mergeProps({ class: "text-3xl font-bold underline" }, _attrs))}> Hello world! </h1>`);
}
...
const MainPage = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender]]);
const MainPage$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: MainPage
});
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(MainPage, _attrs, null, _parent));
    };
  }
});
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-d117da89.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-5fa9db50.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
